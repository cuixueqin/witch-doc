...
```{r, echo=F}
library(data.table)
tab = fread("mod_airquality_timer.csv",sep=",",header=T)
knitr::kable(
tab, booktabs = TRUE,
caption = 'Matching technologies WITCH/TIMER for air quality pollutants factors'
)
```
...
```{r, echo=F}
library(data.table)
tab = fread("mod_airquality_timer_exo.csv",sep=",",header=T)
knitr::kable(
tab, booktabs = TRUE,
caption = 'Matching technologies WITCH/TIMER for exogenous air pollutants emission'
)
```
